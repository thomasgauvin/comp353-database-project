<?php
    ...
    if(!($admin == true || $h_get_user_by_id__userID == $eventManagerId)) {
    ...
    if(!empty($_POST)){
        ...
        && isset($_POST['startDateTime']) && isset($_POST['endDateTime'])) {
            ...
            $updateEventQuery = "UPDATE Event SET EName='{$eName}', EDescription='{$eDescription}',  Address='{$address}', StartDateTime={$startDateTime}, EndDateTime={$endDateTime} WHERE EventID={$h_get_event_details__eventID}";
